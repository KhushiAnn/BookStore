...
import com.bookstore.bookstore_backend.entities.Discussion;
...
class DiscussionServiceTest {
    ...
    void addDiscussion_shouldAddDiscussionToDatabase() {
        ...
        DiscussionDTO savedDiscussionDTO = Assertions.assertDoesNotThrow(() -> discussionService.addDiscussion(personEmail, discussionDTO, bindingResult));
