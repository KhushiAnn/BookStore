...
import com.bookstore.bookstore_backend.dto.PaymentInfoDTO;
...
class PaymentServiceTest {
    ...
    void findPaymentFeesByPersonEmail_shouldReturnPaymentFeesForAuthenticatedPerson() {
        ...
        Double returnedAmount = Assertions.assertDoesNotThrow(() -> paymentService.findPaymentFeesByPersonEmail(personEmail));
    ...
    void createPaymentIntent_shouldCreateValidStripePaymentIntent() {
        ...
        try (MockedStatic<PaymentIntent> paymentIntentMock = mockStatic(PaymentIntent.class)) {
            ...
            PaymentIntent returnedPaymentIntent = Assertions.assertDoesNotThrow(() -> paymentService.createPaymentIntent(paymentInfoDTO));
