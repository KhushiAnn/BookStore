package com.bookstore.bookstore_backend.security.services;

import com.bookstore.bookstore_backend.entities.Person;
import com.bookstore.bookstore_backend.repositories.PersonRepository;
import com.bookstore.bookstore_backend.security.dto.requests.PersonLoginDTO;
import com.bookstore.bookstore_backend.security.dto.requests.PersonRegistrationDTO;
import com.bookstore.bookstore_backend.security.dto.responses.AuthenticationResponse;
import com.bookstore.bookstore_backend.security.entities.PersonDetails;
import com.bookstore.bookstore_backend.security.entities.Role;
import com.bookstore.bookstore_backend.security.jwt.JwtUtils;
import com.bookstore.bookstore_backend.utils.exceptions.PersonException;
import com.bookstore.bookstore_backend.utils.validators.PersonValidator;
...
class AuthenticationServiceTest {
    ...
    void registerPerson_shouldRegisterPersonAndReturnAuthenticationResponseWithJWT() {
        ...
        AuthenticationResponse response = Assertions.assertDoesNotThrow(() -> authenticationService.registerPerson(personRegistrationDTO, bindingResult));
    ...
    void authenticatePerson_shouldCheckCredentialsAndReturnAuthenticationResponseWithJWT() {
        ...
        AuthenticationResponse response = Assertions.assertDoesNotThrow(() -> authenticationService.authenticatePerson(personLoginDTO, bindingResult));
